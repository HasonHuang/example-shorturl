...
public class JsonMapper {
    ...
    /** 输出非 null 属性的实例 */
    public static final JsonMapper INSTANCE_NON_NULL = nonNullMapper();
     ...
     * <pre>
     *     {@code fromJson(jsonString, new TypeReference<List<Bean>>() {});}
     * </pre>
     */
    ...
    /**
     * 设定是否使用 Enum 的 toString 函数来读写 Enum，为 FALSE 时使用 Enum.name() 读写 Enum，默认为 FALSE。
     * 注意本函数一定要在 Mapper 创建后、所有读写动作之前调用。
     */
